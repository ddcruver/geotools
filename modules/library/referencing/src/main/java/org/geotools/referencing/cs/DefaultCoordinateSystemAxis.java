...
public class DefaultCoordinateSystemAxis extends AbstractIdentifiedObject
    ...
    /**
     * Number of items in {@link #PREDEFINED}. Should be considered as a constant after the class
     ...
     *
     * <p>The ISO 19111 name is "<cite>geodetic longitude</cite>" and the abbreviation is "&lambda;"
     * (lambda).
     *
     ...
     * SI#METER metres}.
     *
     * <p>The ISO 19111 name is "<cite>gravity-related height</cite>" and the abbreviation is lower
     * case "<var>H</var>".
     *
     * @see #ALTITUDE
     ...
     *
     * <p>Increasing ordinates values go {@linkplain AxisDirection#DOWN down} and units are
     ...
     * SI#METER metres}.
     *
     * <p>The ISO 19111 name is "<cite>geocentric radius</cite>" and the abbreviation is lower case
     * "<var>r</var>".
     *
     ...
     * {@linkplain NonSI#DEGREE_ANGLE decimal degrees}.
     *
     * <p>The ISO 19111 name is "<cite>spherical longitude</cite>" and the abbreviation is "&Omega;"
     * (omega).
     *
     * <p>This axis is usually part of a {@link #SPHERICAL_LONGITUDE}, {@link #SPHERICAL_LATITUDE},
     * {@link #GEOCENTRIC_RADIUS} set.
     ...
     * {@linkplain NonSI#DEGREE_ANGLE decimal degrees}.
     *
     * <p>The ISO 19111 name is "<cite>spherical latitude</cite>" and the abbreviation is "&Theta;"
     * (theta).
     *
     * <p>This axis is usually part of a {@link #SPHERICAL_LONGITUDE}, {@link #SPHERICAL_LATITUDE},
     * {@link #GEOCENTRIC_RADIUS} set.
     ...
     * "<var>X</var>".
     *
     * <p>This axis is usually part of a {@link #GEOCENTRIC_X}, {@link #GEOCENTRIC_Y}, {@link
     * #GEOCENTRIC_Z} set.
     */
    ...
    /**
     * Some names to be treated as equivalent. This is needed because axis names are the primary way
     * to distinguish between {@link CoordinateSystemAxis} instances. Those names are strictly
     ...
     * axis.
     *
     * <p>Keys in this map are names <strong>in lower cases</strong>. Values are the axis that the
     ...
     * @return {@code true} if the second name is equivalent to "x" or "y" (depending on the {@code
     *     xy} value), or {@code false} otherwise.
     */
    ...
    /**
     * Constructs a new coordinate system axis with the same values than the specified one. This
     * copy constructor provides a way to wrap an arbitrary implementation into a Geotools one or a
    ...
    /**
     * Constructs an axis with a name and an abbreviation as a resource bundle key. To be used for
     * construction of pre-defined constants only.
     *
    ...
    /**
     * Returns a predefined axis similar to the specified one except for units. Returns {@code null}
     * if no predefined axis match.
     */
     ...
     * minimum} and {@linkplain #getMaximumValue maximum} values. This element shall be omitted when
     * both minimum and maximum values are omitted. It may be included when minimum and/or maximum
     * values are included. If this element is omitted when minimum or maximum values are included,
     * the meaning is unspecified.
     *
     * @since 2.3
     */
    ...
    /**
     * Returns {@code true} if the specified direction is a compass direction. Compass directions
     * include "<cite>North</cite>", "<cite>North-North-East</cite>", "<cite>North-East</cite>",
     * <cite>etc.</cite>
     *
