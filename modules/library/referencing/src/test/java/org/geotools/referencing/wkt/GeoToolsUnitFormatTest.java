...
public class GeoToolsUnitFormatTest {
    ...
    /**
     * Test method for {@link UnitFormat#format(Unit, Appendable)} for units that have labels or
     * aliases defined in the default format. The goal is ensuring that the label and alias
     * definitions have been correctly cloned from the default format instance to the GT format
     * instances.
     */
    @Test
